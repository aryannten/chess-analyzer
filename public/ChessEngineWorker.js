...
console.log(`%c ChessEngineWorker v${WORKER_VERSION} loaded at ${BUILD_TIMESTAMP}`, 'background: #4CAF50; color: white; padding: 4px 8px; border-radius: 3px; font-weight: bold;');
console.log('%c Worker features: instant initialization + smart move generation + cache-fix', 'color: #2196F3; font-weight: bold;');
console.log('%c If you see this message, the worker loaded successfully!', 'color: #4CAF50;');
